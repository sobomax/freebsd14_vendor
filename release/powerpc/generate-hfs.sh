...
# $FreeBSD: releng/11.3/release/powerpc/generate-hfs.sh 329145 2018-02-12 01:08:44Z kevans $
...
echo '$FreeBSD: releng/11.3/release/powerpc/generate-hfs.sh 329145 2018-02-12 01:08:44Z kevans $' >> $OUTPUT_FILE.bz2.uu
