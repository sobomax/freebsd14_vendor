...
# $FreeBSD: releng/11.3/stand/powerpc/boot1.chrp/generate-hfs.sh 305901 2016-09-17 16:45:57Z jhibbits $
...
echo '# $FreeBSD: releng/11.3/stand/powerpc/boot1.chrp/generate-hfs.sh 305901 2016-09-17 16:45:57Z jhibbits $' >> Makefile.hfs
...
echo '$FreeBSD: releng/11.3/stand/powerpc/boot1.chrp/generate-hfs.sh 305901 2016-09-17 16:45:57Z jhibbits $' >> $OUTPUT_FILE.bz2.uu
