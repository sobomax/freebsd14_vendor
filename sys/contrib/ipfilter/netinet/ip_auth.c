/*	$FreeBSD: releng/12.2/sys/contrib/ipfilter/netinet/ip_auth.c 344833 2019-03-06 02:37:25Z cy $	*/
...
#if !defined(lint)
static const char rcsid[] = "@(#)$FreeBSD: releng/12.2/sys/contrib/ipfilter/netinet/ip_auth.c 344833 2019-03-06 02:37:25Z cy $";
