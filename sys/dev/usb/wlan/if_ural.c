/*	$FreeBSD: releng/11.3/sys/dev/usb/wlan/if_ural.c 343976 2019-02-10 21:00:02Z avos $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: releng/11.3/sys/dev/usb/wlan/if_ural.c 343976 2019-02-10 21:00:02Z avos $");
