/*	$FreeBSD: releng/12.2/sys/dev/usb/wlan/if_rum.c 343975 2019-02-10 20:59:35Z avos $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: releng/12.2/sys/dev/usb/wlan/if_rum.c 343975 2019-02-10 20:59:35Z avos $");
