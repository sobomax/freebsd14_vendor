/*	$FreeBSD: releng/11.3/sys/dev/usb/wlan/if_rum.c 345635 2019-03-28 09:18:22Z avos $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: releng/11.3/sys/dev/usb/wlan/if_rum.c 345635 2019-03-28 09:18:22Z avos $");
